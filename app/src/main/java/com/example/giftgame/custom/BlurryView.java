package com.example.giftgame.custom;
...
public class BlurryView extends View {
    ...
    public BlurryView(Context context, AttributeSet attrs) {
        ...
        mBlurRadius = a.getDimension(R.styleable.BlurryView_blurRadius,
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics()));
        mDownsampleFactor = a.getFloat(R.styleable.BlurryView_downSampleFactor, 4);
        mOverlayColor = a.getColor(R.styleable.BlurryView_overlayColor, 0xAAFFFFFF);
        a.recycle();
    ...
    protected boolean prepare() {
        ...
        float sampleFactor = mDownsampleFactor;
        float radius = mBlurRadius / sampleFactor;
        if (radius > 25) {
            sampleFactor = sampleFactor * radius / 25;
            radius = 25;
        }
        ...
        int scaledWidth = Math.max(1, (int) (width / sampleFactor));
        int scaledHeight = Math.max(1, (int) (height / sampleFactor));
